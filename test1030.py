...
user1 = Person("Alice", 30, "010313131313")
...
user1 = Student("alice", 23, "010328392893")
user2 = Teacher("bob", 25, "0102392839")
...
p1 = Person("python", 23 ,"01037247")
p2 = Person("hello", 21, "010232131231")
